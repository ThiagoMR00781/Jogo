...
let body_img = document.getElementById("body_img");
...
function inicio(){
    ...
    body_img.style.backgroundImage = "url(img/biblioteca3.jpg)";
    body_img.style.backgroundSize = "cover"
}
...
function cenario1(){
    ...
    body_img.style.backgroundImage = "url(img/rua1.jpg)";
    body_img.style.backgroundSize = "1380px 720px"
}
...
function cenario3(){
    ...
    botao2.style.display = "block";
    body_img.style.backgroundImage = "url(img/floresta.jpg)";
    body_img.style.backgroundSize = "cover"
}
...
function cenario4(){
    ...
    botao2.style.display = "block";
    body_img.style.backgroundImage = "url(img/vilareijo1.png)";
    body_img.style.backgroundSize = "cover"
}
...
function cenario5(){
    ...
    botao2.style.display = "none";
    body_img.style.backgroundImage = "url(img/morte.png)";
    body_img.style.backgroundSize = "cover"
}
...
function cenario6(){
    ...
    botao2.style.display = "block";
    body_img.style.backgroundImage = "url(img/taberna.png)";
    body_img.style.backgroundSize = "cover"
}
...
function cenario9(){
    ...
    botao2.innerHTML = "Volta para o início"; 
    botao2.style.display = "none";
    body_img.style.backgroundImage = "url(img/casa.jpg)";
    body_img.style.backgroundSize = "cover"
}
...
function cenario14(){
    ...
    botao2.innerHTML = "Volta para o início"; 
    botao2.style.display = "none";
    body_img.style.backgroundImage = "url(img/monstro.jpg)";
    body_img.style.backgroundSize = "cover"
}
...
function cenario15(){
    ...
    botao2.innerHTML = "Volta para o início"; 
    botao2.style.display = "none";
    body_img.style.backgroundImage = "url(img/mago.jpg)";
    body_img.style.backgroundSize = "cover"
}
...
function cenario18(){
    ...
    botao2.style.display = "block";
    body_img.style.backgroundImage = "url(img/casadaguerreira.jpg)";
    body_img.style.backgroundSize = "cover"
}
